...
def debug_image_quality():
    ...
    for image_file in image_files:
        ...
        print(f"Raw Heuristics:")
        print(f"  Blurry: {raw_heuristics['blurry'][0]} (score: {raw_heuristics['blurry'][1]:.2f})")
        print(f"  Poor exposure: {raw_heuristics['poor_exposure'][0]} (values: {raw_heuristics['poor_exposure'][1]})")
        print(f"  Too small: {raw_heuristics['too_small'][0]} (size: {raw_heuristics['too_small'][1]})")
