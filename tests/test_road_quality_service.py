...
from src.services.road_quality import RoadQualityService, RoadQualityMetrics
...
class TestRoadQualityService(unittest.TestCase):
    ...
    def test_assess_road_quality_success(self, mock_preprocessor_class, mock_factory):
        ...
        with patch('src.services.road_quality.road_quality_service.RoadQualityMetrics') as mock_metrics:
...
class TestIntegration(unittest.TestCase):
    ...
    def test_end_to_end_assessment(self, mock_yolo):
        ...
        with patch('src.services.road_quality.metrics.RoadQualityMetrics.from_model_output') as mock_from_output:
