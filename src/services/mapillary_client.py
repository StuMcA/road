...
class MapillaryClient:
    ...
    def fetch_images(
        ...
        response = requests.get(f"{self.BASE_URL}?bbox={mapillary_bbox}", params=params)
    ...
    def download_images(self, images: List[Dict], output_dir: str = "mapillary_images") -> List[str]:
