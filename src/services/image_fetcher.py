...
class ImageFetcherService:
    ...
    def fetch_images_at_point(
        ...
        try:
            ...
            # Download images
            downloaded_paths = self.mapillary_client.download_images(
                image_metadata, output_dir
            )
    ...
    def fetch_and_process_images(
        ...
        fetch_result = self.fetch_images_at_point(
            lat, lon, radius_m, limit, output_dir
        )
