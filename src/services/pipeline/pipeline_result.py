...
from ..image_quality import ImageQualityMetrics, ImageFailureReason
...
class PipelineResult:
    ...
    def summary(self) -> str:
        ...
        if not self.processed_successfully:
            reasons = ", ".join([reason.display_message for reason in self.quality_metrics.failure_reasons])
    ...
    @classmethod
    def create_quality_failed(cls, image_path: str, quality_metrics: ImageQualityMetrics, 
                            processing_time_ms: float) -> "PipelineResult":
    ...
    @classmethod
    def create_success(cls, image_path: str, quality_metrics: ImageQualityMetrics,
                      road_metrics: RoadQualityMetrics, processing_time_ms: float) -> "PipelineResult":
